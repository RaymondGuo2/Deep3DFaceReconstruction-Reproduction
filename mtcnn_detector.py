# Code taken from https://github.com/sicxu/Deep3DFaceRecon_pytorch/issues/85#issuecomment-1137456892
...
def main(args):
    ...
    detections_dir = os.path.join(directory, 'detections')
    ...
    for file in os.listdir(directory):
         ...
         if filename.lower().endswith((".jpg", ".png")):
             ...
             if filename.endswith(".jpg"):
                ...
                f = open(os.path.join(directory, 'detections', file.replace('.png', '.txt')), "w")
            ...
            #  f2 = open(os.path.join(directory, 'detections\\', file.replace('.jpg', '.center')), "w")
             if filename.endswith(".jpg"):
                ...
                f2 = open(os.path.join(directory, 'detections', file.replace('.png', '.center')), "w")
